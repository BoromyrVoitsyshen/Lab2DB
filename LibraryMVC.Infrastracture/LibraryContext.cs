...
public partial class LibraryContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BorrowedBook>(entity =>
        {
            ...
            entity.Property(e => e.ID).HasColumnName("borrow_ID");
            entity.Property(e => e.BookId).HasColumnName("book_ID");
            ...
            entity.Property(e => e.BookTitle).HasMaxLength(60).HasColumnName("book_title");
            entity.Property(e => e.ReaderName).HasMaxLength(60).HasColumnName("reader_name");
        ...
        modelBuilder.Entity<Reader>(entity =>
        {
            ...
            entity.Property(e => e.ID).HasColumnName("reader_ID");
            entity.Property(e => e.ContactInfo)
                .HasMaxLength(120)
                .HasColumnName("contactInfo");
            entity.Property(e => e.Name)
